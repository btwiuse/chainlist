...
function Home({ changeTheme, theme }) {
  const { data, error } = useSWR('https://btwiuse.github.io/chains/chains.json', fetcher)
          ...
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              ...
              <div className={ classes.socials }>
                <a className={ `${classes.socialButton}` } href='https://github.com/btwiuse/chainlist' target='_blank' rel="noopener noreferrer" >
